...
with open( 'epidemics_neighbourhood_Dec29_redo.json', 'r' ) as f :
    data = f.read()

count = len(data.split('}, {')) #should be 800
print 'neighbourhood epidemics -redo', count
...
with open( 'epidemics_neighbourhood_Dec29.json', 'r' ) as f :
    data = f.read()
...
with open( 'epidemics_exponential_Dec29.json', 'r' ) as f :
    data = f.read()
...
with open( 'epidemics_powerlaw_Dec29.json', 'r' ) as f :
    data = f.read()
