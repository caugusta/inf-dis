...
with open( 'epidemics_neighbourhood_23Dec.json', 'r' ) as f :
    data = f.read()
...
with open('Dec23_neighbourhood_epidemics.txt', 'w') as f:
	np.savetxt(f, np.c_[times, infindivs], fmt=['%i', '%i'])

print 'wrote Dec23_neighbourhood_epidemics.txt'


##Exponential

with open( 'epidemics_exponential_23Dec.json', 'r' ) as f :
    data = f.read()
...
with open('Dec23_exponential_epidemics.txt', 'w') as f:
        np.savetxt(f, np.c_[times, infindivs], fmt=['%i', '%i'])

print 'wrote Dec23_exponential_epidemics.txt'

##Powerlaw

with open( 'epidemics_powerlaw_23Dec.json', 'r' ) as f :
    data = f.read()
...
with open('Dec23_powerlaw_epidemics.txt', 'w') as f:
        np.savetxt(f, np.c_[times, infindivs], fmt=['%i', '%i'])

print 'wrote Dec23_powerlaw_epidemics.txt'
